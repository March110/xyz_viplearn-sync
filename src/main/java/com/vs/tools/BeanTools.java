...
public class BeanTools {
	...
	*/
	...
	public static void createSqlMap(Object bean, String filePath) throws Exception{
		...
		info.append("<!DOCTYPE mapper PUBLIC \"-//mybatis.org//DTD Mapper 3.0//EN\" \"http://mybatis.org/dtd/mybatis-3-mapper.dtd\">").append("\n");
		info.append("\n");
		...
		info.append("\n");
		info.append("<mapper namespace=\"").append(bean.getClass().getCanonicalName()).append("\">").append("\n");
		info.append("\n");
		info.append("  <resultMap id=\"").append(StringUtils.toLowerCaseFirstOne(bean.getClass().getSimpleName())).append("Result").append("\" type=\"").append(bean.getClass().getCanonicalName()).append("\">").append("\n");
		...
		info.append("			<if test=\"_parameter != null\">").append("\n");
		info.append("				id = #{value}").append("\n");
		info.append("			</if>").append("\n");
		info.append("		</where>").append("\n");
		...
		info.append("		<where>").append("\n");
		for(int i = 0; i < propertis.size(); i++){
			info.append("			<if test=\"").append(propertis.get(i)).append(" != null\">").append("\n");
			info.append("				and ").append(StringUtils.toUnderlineName(propertis.get(i))).append(" = #{").append(propertis.get(i)).append("}").append("\n");
			info.append("			</if>").append("\n");
		}
		info.append("		</where>").append("\n");
		info.append("		<if test=\"orderBy != null\">").append("\n");
		info.append("			order by ${orderBy}").append("\n");
		info.append("		</if>").append("\n");
		info.append("		<if test=\"limit != null\">").append("\n");
		info.append("			limit ${start}, ${end}").append("\n");
		info.append("		</if>").append("\n");
		info.append("  </select>").append("\n");
		info.append("\n");
		info.append("  <insert id=\"insert\" parameterType=\"").append(bean.getClass().getCanonicalName()).append("\" useGeneratedKeys=\"true\" keyProperty=\"uuid\">").append("\n");
		...
		info.append("\n");
		info.append("  <select id=\"count\" resultType=\"int\">").append("\n");
		...
		info.append("  </select>").append("\n");
		info.append("\n");
		info.append("  <update id=\"update\" parameterType=\"").append(bean.getClass().getCanonicalName()).append("\">").append("\n");
		...
		info.append("  </update>").append("\n");
		info.append("</mapper>").append("\n");

		FileTools fileTools = new FileTools();
		fileTools.addTxtEnd(filePath + bean.getClass().getSimpleName() + "Mapper.xml", info.toString());
	}
	
	public static void main(String[] strings) throws Exception{
		BeanTools.createSqlMap(new Classes(), "d:\\");
	}
}
